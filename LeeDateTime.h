...
private:
	...
	constexpr static double THREE_MILLISECOND = 3 / 1000.0 / 3600.0 / 24.0;//三毫秒. 当两个CLeeDateTimeSpan之差在此之内时,则认为二者相等.
};
...
private:
	...
	constexpr static double THREE_MILLISECOND = 3 / 1000.0 / 3600.0 / 24.0;//三毫秒. 当两个CLeeDateTime之差在此之内时,则认为二者相等.
};
